...
<!-- What the AI needs to know RIGHT NOW to be productive -->

**Current Focus:** [What we're actively working on]

**Key Files:**
- [Primary file being edited]
- [Related files to be aware of]

**Blockers:** [Any current blockers, or "None"]

## Current Task Breakdown

<!-- For complex tasks, maintain a checklist. Clear when feature complete. -->

Feature: [Feature Name]
- [ ] Subtask 1
- [ ] Subtask 2
  - [ ] Sub-subtask if needed
- [ ] Subtask 3
